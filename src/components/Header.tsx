          ...
          <div className="flex items-center justify-between h-28">
            ...
            <div className="flex-shrink-0">
              <Link href="/" className="flex items-center gap-3 group">
                ...
                >
                  <span className="text-4xl md:text-[2.6rem] bg-gradient-to-br from-[#ff6b6b] via-ts-red to-[#c0001a] bg-clip-text text-transparent drop-shadow-[0_0_14px_rgba(229,9,20,0.45)] group-hover:drop-shadow-[0_0_22px_rgba(229,9,20,0.75)] transition-all duration-300">
                    Sevran
                  </span>
                </span>
              </Link>
